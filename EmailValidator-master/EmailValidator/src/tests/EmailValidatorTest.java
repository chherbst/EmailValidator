...
public class EmailValidatorTest {
	...
	public void testValidate() {
		...
		assertFalse(emailValidator.validate("christoph.herbst.@mail.tu-berlin.de"));
        assertTrue(emailValidator.validate("sediqi@mailbox.tu-berlin.de"));
		...
		assertTrue(emailValidator.validate("waheedullah7@gmail.com"));
		...
		assertFalse(emailValidator.validate("test.email@email@com.com.com"));
